...
final class MakeModuleTaskCommand extends GeneratorCommand
{
    use ModuleCommandTrait;

    protected $argumentName = 'name';

    protected $name = 'make:module-task';
    ...
    {
        return config('modules.paths.generator.tasks.namespace', 'Tasks');
    }
    ...
    protected function getTemplateContents(): string
    {
        ...
        return $this->getStubContents(__DIR__ . '/stubs/tasks' . $this->getStubName(), [
