            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <a class="dropdown-item" href="{{ route('dashboard.profile.edit') }}"><span
                                class="align-middle">Settings</span></a>
                        <x-dashboard.logout-button class="dropdown-item" :action="route('auth.logout')" method="delete">
                            <i class="mdi mdi-logout text-muted fs-16 me-1 align-middle"></i> <span class="align-middle"
